...
export declare class TicketsService {
    ...
    constructor(prisma: PrismaService, ticketsGateway: TicketsGateway, redis: Redis);
    findOne(ticketId: number): Promise<{
        trips: {
            id: number;
    ...
    update(ticketId: number, dto: UpdateTicketDto): Promise<{
        trips: {
            id: number;
            company_route_id: number;
            vehicle_type_id: number | null;
    ...
    createManualTicket(dto: CreateTicketDto): Promise<{
        message: string;
        ticket: {
            ticket_details: {
                id: number;
    ...
    createPublicBooking(dto: CreatePublicBookingDto, user?: {
        customer_id: number;
    }): Promise<{
        message: string;
        tickets: {
