...
export class RouteController {
  ...
  async requestRouteByCompany(
    ...
    return this.routeService.requestRouteByCompany(routeId, req.user as AuthenticatedUser);
  }
  ...
  async getMyCompanyRoutes(@Req() req: Request) {
    ...
    console.log(user);
    if (!user.company_id) {
      throw new UnauthorizedException('Thông tin công ty không tìm thấy trong token.');
    }
  ...
  async removeMyCompanyRoute(
    ...
    return this.routeService.removeMyCompanyRoute(routeId, req.user as AuthenticatedUser);
  }
  ...
  async getAllAvailableRoutes(@Req() req: Request) {
    return this.routeService.getAllRoutesWithoutCompanyInfo(req.user as AuthenticatedUser);
  }

  @Post()
  @Roles(UserRole.ADMIN)
  async create(@Body() createRouteDto: CreateRouteDto, @Req() req: Request) {
    return this.routeService.createRoute(createRouteDto, req.user as AuthenticatedUser);
  }
  ...
  async getAllRoutesForAdmin(
    ...
    if (companyId !== undefined) {
      return this.routeService.getRoutesByCompanyId(companyId, req.user as AuthenticatedUser);
    } else {
  ...
  @Patch(':id')
  @Roles(UserRole.ADMIN)
  async update(@Param('id', ParseIntPipe) id: number, @Body() updateRouteDto: UpdateRouteDto, @Req() req: Request) {
    return this.routeService.updateRoute(id, updateRouteDto, req.user as AuthenticatedUser);
  }
  ...
  @Post('assign')
  @Roles(UserRole.ADMIN)
  async assignRouteToCompany(@Body() createCompanyRouteDto: CreateCompanyRouteDto, @Req() req: Request) {
    return this.routeService.assignRouteToCompany(createCompanyRouteDto, req.user as AuthenticatedUser);
  }
  ...
  async removeCompanyRoute(
    ...
    return this.routeService.removeCompanyRoute(companyId, routeId, req.user as AuthenticatedUser);
  }
  ...
  async updateApprovalStatus(
    ...
    return this.routeService.updateCompanyRouteApproval(companyId, routeId, approved, req.user as AuthenticatedUser);
  }
}